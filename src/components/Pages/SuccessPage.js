    ...
    return(
        <Confirmation>
            ...
            <MovieAndSession>
                ...
                <p data-identifier="movie-session-infos-reserve-finished">{movieAndSession.title}</p>
                <p data-identifier="movie-session-infos-reserve-finished">{movieAndSession.date}</p>
            </MovieAndSession>
            ...
            <Customer>
                <h2>Comprador</h2>
                <p data-identifier="buyer-infos-reserve-finished">Nome: {customer.name}</p>
                <p data-identifier="buyer-infos-reserve-finished">CPF: {customer.cpf}</p>
            </Customer>
